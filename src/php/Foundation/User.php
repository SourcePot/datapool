...
class User implements \SourcePot\Datapool\Interfaces\HomeApp{
    ...
    private const DEFINITION=[
        ...
        'My search interests'=>['@function'=>'selectClassesImplementingInterface','@class'=>'SourcePot\Datapool\Tools\HTMLbuilder','@interface'=>'SourcePot\Datapool\Interfaces\Haystack','@element-content'=>'Attention: you need to logout and login again to apply changes','@isApp'=>'🔍','@hideKeys'=>TRUE,'@hideCaption'=>TRUE],
