...
class Dictionary implements \SourcePot\Datapool\Interfaces\App{
    ...
    private const INIT_DICTIONARY=[
        'de'=>[
            ...
            'Map'=>'Karte',
            'Message*'=>'Nachricht',
            'Message is too short'=>'Nachricht ist zu kurz',
        ...
        'es'=>[
            ...
            'Map'=>'Mapa',
            'Message*'=>'Mensaje',
            'Message is too short'=>'El mensaje es insuficiente',
            ...
            'Permitted'=>'Permitido',
            'Phone'	=>'Teléfono',
            'Please provide a valid email address'=>'Por favor, introduzca una dirección de correo electrónico válida',
