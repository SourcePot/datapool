...
class Invoices implements \SourcePot\Datapool\Interfaces\Job,\SourcePot\Datapool\Interfaces\App{
    ...
    */
    ...
    public function run(array|bool $arr=TRUE):array
    {
        $html='';
        if ($arr===TRUE){
            return ['Category'=>'Data','Emoji'=>'&#9854;','Label'=>'Invoices','Read'=>self::APP_ACCESS,'Class'=>__CLASS__];
        } else {
