...
final class Root{
    ...
    public const ADD_VENDOR_CLASSES=array('SourcePot\MediaPlayer\MediaPlayer','SourcePot\Sms\Sms','SourcePot\FhGInvoices\FhGInvoices','SourcePot\statistic\statistic');
